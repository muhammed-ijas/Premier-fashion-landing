        ...
        <section id="team" className="surface-light pb-8 pt-14 md:py-20">
            ...
            final row sits under the others rather than floating centred. */}
                      ...
                      background-removed PNGs all sit on the same card */}
                                    ...
                                    <h3 className="mt-2.5 text-[0.66rem] font-semibold uppercase leading-snug tracking-[0.03em] text-ink transition-colors duration-300 group-hover:text-blue">
                                        {member.name}
                                    </h3>
                                    <p className="mt-1 text-[0.6rem] leading-[1.5] text-fg-muted">
                                        {member.role}
                                    </p>
                                </article>
                            </Stagger.Item>
